...
export function DiningNav() {
    return (
        <Sheet>
            ...
            <SheetContent
                side="bottom"
                className="h-[85vh] rounded-t-[20px] p-0 overflow-hidden flex flex-col"
            >
                {/* 
                    Single scrollable container for the entire content.
                    This is significantly more reliable on mobile than nested flex scrolling.
                */}
                <div className="flex-1 overflow-y-auto overscroll-contain" style={{ WebkitOverflowScrolling: 'touch' }}>
                    ...
                    <div className="p-6 pt-2 gap-6 flex flex-col">
                        {/* Tanuki Raw */}
                    ...
                    <div className="p-6 bg-zinc-100 border-t mt-4">
